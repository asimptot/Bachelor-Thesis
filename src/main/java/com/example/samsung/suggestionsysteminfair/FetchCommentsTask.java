...
public class FetchCommentsTask extends AsyncTask<String, Void, String[]> {
    ...
    public FetchCommentsTask(Activity activity) {
    ...
    protected String[] doInBackground(String... params) {
        ...
        try {
            ...
            final String FORECAST_BASE_URL =
                    "https://api.foursquare.com/v2/venues/" + params[0] + "/tips?sort=recent";
    ...
    protected void onPostExecute(String[] result) {
        if (result != null && result.length >= 1) {
            ...
            bundle.putStringArrayList("venueList", new ArrayList<>(Arrays.asList(result)));
